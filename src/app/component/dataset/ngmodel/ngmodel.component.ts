...
this.editgrp(this.Data.converted)
      ...
      //               const newcustomfieldindex = this.options.findIndex(item =>
      ...
      //             item.fieldtype === result.fieldtype
      //           );    
  ...
  savegrp() {
    ...
    this.grp.forEach((element1: any, index: number) => {
      ...
      element1.forEach((_:any, i: number) => {
        ...
        //   if (operator.anotherfieldtype == "date" && operator.value == "in_between" && operator.anotherfield == true) {
        //     // value = [this.startdate[index], this.enddate[index]];
        //   } else {
        //     // value = this.startdate[index];
        //   }
        // } else {
